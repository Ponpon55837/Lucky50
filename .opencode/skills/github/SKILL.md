---
name: github
description: GitHub Copilot skills 路由器與專案整合指引 - 提供 skills 載入、README 維護判斷與軟路由機制
license: MIT
---
...
README 變更通常應與相關功能或規範變更一起交付；純文件修正可獨立提交。
...
| Skill          | 描述                                       | 自動載入觸發詞                 |
| -------------- | ------------------------------------------ | ------------------------------ |
| `code-standards` | Lucky50 專案開發規範與最佳實踐             | lucky50, 專案規範, 開發指南    |
...
3. ✅ 依 README 影響判斷載入 `github/README.md`
